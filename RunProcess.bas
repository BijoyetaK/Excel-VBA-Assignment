...
'THIS PROCEDURE USES DICTIONARY. TO ENABLE THE FEATURES, INSIDE VBA IDE GO TO TOOLS -> REFERENCES -> Scroll down, select the ‘Microsoft Scripting Runtime’ option, then click “OK.”
...
'Defining the column position in their variables
